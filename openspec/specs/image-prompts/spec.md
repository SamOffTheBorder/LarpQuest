# image-prompts Specification

## Purpose

The `illustrator` model role and the post-publish, never-blocking write path that generates text image-generation prompts for a published chapter and writes them to `chapters.image_prompts`.
