...
Proposal evaluation against universe rules, active progression model, and entity state, Zod-parsed verdict output, the `proposals` table, and threading the ruling into the Narrator's turn context.
