...
Owner/GM-gated mid-story turn mode switching: updating a story's active mode, an append-only audit trail of every switch, and effective-from-next-turn semantics so no already-created turn is ever retroactively changed.
