...
The per-universe-version context policy (recency, retrieval, compression, and token-budget knobs) and the synchronous generation of compressed canon-bible representations at universe-version publish time.
