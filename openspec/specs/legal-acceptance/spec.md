# legal-acceptance Specification

## Purpose

Serving the Terms of Service, Privacy Policy, and Acceptable Use Policy in-app from their source Markdown, and recording each sign-in's confirmed agreement to the current version of all three as an auditable, email-keyed acceptance trail.
