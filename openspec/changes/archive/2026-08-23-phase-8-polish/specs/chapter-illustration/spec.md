...
Generated chapter images SHALL be readable only by members of the owning story, except when served through a valid, unexpired share-link signed URL.
...
- **WHEN** a user who is not a member of the story requests a chapter's generated image directly
